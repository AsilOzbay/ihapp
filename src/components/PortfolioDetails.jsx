  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-black dark:text-white p-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-6">
        ...
        <LineChart width={600} height={300} data={totalInvestedData} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
          <XAxis dataKey="date" />
          <YAxis />
          <Tooltip />
          <Legend />
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-6 flex flex-col md:flex-row">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-6">
        ...
        <img src={portfolio.avatar} alt={`${portfolio.name} avatar`} className="w-16 h-16 rounded-full mb-4" />
